...
public class ArticleListActivity extends AppCompatActivity implements
    ...
    private class ArticlesAdapter extends RecyclerView.Adapter<ArticleViewHolder> {
        ...
        public void onBindViewHolder(final ArticleViewHolder holder, int position) {
            ...
            Glide
                    .with(holder.mThumbnail.getContext())
                            ...
                            Palette.from(bitmap).generate(new Palette.PaletteAsyncListener() {
                                ...
                                public void onGenerated(Palette palette) {
                                    ...
                                    if (swatch != null) {
                                        ...
                                        holder.mArticleTitle.setTextColor(swatch.getTitleTextColor());
                                        holder.mArticleAuthor.setTextColor(swatch.getBodyTextColor());
                                        holder.mArticlePublishDate.setTextColor(swatch.getBodyTextColor());
                                    }
                                }
                            });
